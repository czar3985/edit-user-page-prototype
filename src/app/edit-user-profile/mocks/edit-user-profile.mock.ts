...
export const MOCK_GROUPED_LOCATIONS: GroupedLocationsResponse = {
    ...
    data: [{
        ...
        sublocations: [{
            ...
            isLinkedToUser: true
        }, {id: '20000000-0000-0000-0000-000000000013', name: 'Sub Location A3', isLinkedToUser: false}]
    }, {
        ...
        }, {id: '20000000-0000-0000-0000-000000000022', name: 'Sub Location B2', isLinkedToUser: false}]
    }]
};
export const MOCK_PRIMARY_LOCATION_SEARCH: LocationSearchResponse = {
    data: [{
        ...
        parentLocationName: null,
        sublocations: null
    }], skipCount: 0, startIndex: 0, takeSize: 20, totalCount: 2
};
export const MOCK_ACCESSIBLE_LOCATION_SEARCH: LocationSearchResponse = {
    data: [{
        ...
        id: '20000000-0000-0000-0000-000000000021',
        name: 'Sub Location B1',
        parentLocationId: '10000000-0000-0000-0000-000000000002',
        parentLocationName: 'Primary Location B',
        sublocations: null,
        isLinkedToUser: false
    }], skipCount: 0, startIndex: 0, takeSize: 20, totalCount: 2
};
